...
module ename_coms
   ...
   type ename_vars
      ...
      character(len=str_len)                            :: soilwater_db
      integer                                           :: n_soilwater_points
      integer               , dimension(60)             :: soilwater_years
      integer               , dimension(60)             :: soilwater_months
      integer               , dimension(60)             :: soilwater_dates
   ...
   subroutine init_ename_vars(enl)
      ...
      enl%soilwater_db              =     undef_path
      enl%ed_met_driver_db          =     undef_path
      enl%n_soilwater_points        =     undef_integer
      enl%soilwater_years           = (/ (undef_integer, i=1,60) /)
      enl%soilwater_months          = (/ (undef_integer, i=1,60) /)
      enl%soilwater_dates           = (/ (undef_integer, i=1,60) /)
...
#if defined(COUPLED)
#else
      enl%include_lakesite          = undef_integer
      enl%waterfrac                 = undef_real
#endif
