...
module lake_coms
   ...
   !----- Local constants -----------------------------------------------------------------!
   real(kind=8), parameter :: z0fac_water8 = 1.6d-2 / dble(grav)
   !---------------------------------------------------------------------------------------!
   
   !----  Min. water roughness height -----------------------------------------------------!
   real(kind=8), parameter :: min_waterrough8 = 1.0d-4
   !---------------------------------------------------------------------------------------!
   ...
   subroutine zero_lakesite(lake)
      ...
      lake%co2budget_storage     = 0.d0
      lake%co2budget_loss2atm    = 0.d0
      lake%ebudget_storage       = 0.d0
      lake%ebudget_loss2atm      = 0.d0
      lake%ebudget_loss2drainage = 0.d0
      lake%ebudget_loss2runoff   = 0.d0
      lake%wbudget_storage       = 0.d0
      lake%wbudget_loss2atm      = 0.d0
      lake%wbudget_loss2drainage = 0.d0
      lake%wbudget_loss2runoff   = 0.d0
      !------------------------------------------------------------------------------------!
   ...
   subroutine clone_lakesite(lakein,lakeout)
      ...
      lakeout%avg_rlong_gnd         = lakein%avg_rlong_gnd
      ...
      lakeout%upwp                  = lakein%upwp
      lakeout%tpwp                  = lakein%tpwp
      lakeout%qpwp                  = lakein%qpwp
      lakeout%cpwp                  = lakein%cpwp
      lakeout%wpwp                  = lakein%wpwp
      ...
      lakeout%co2budget_storage     = lakein%co2budget_storage
      lakeout%co2budget_loss2atm    = lakein%co2budget_loss2atm
      lakeout%ebudget_storage       = lakein%ebudget_storage
      lakeout%ebudget_loss2atm      = lakein%ebudget_loss2atm
      lakeout%ebudget_loss2drainage = lakein%ebudget_loss2drainage
      lakeout%ebudget_loss2runoff   = lakein%ebudget_loss2runoff
      lakeout%wbudget_storage       = lakein%wbudget_storage
      lakeout%wbudget_loss2atm      = lakein%wbudget_loss2atm
      lakeout%wbudget_loss2drainage = lakein%wbudget_loss2drainage
      lakeout%wbudget_loss2runoff   = lakein%wbudget_loss2runoff
      !------------------------------------------------------------------------------------!
   ...
   subroutine integ_lakesite(lake,dlakedt,dtim)
      ...
      lake%avg_rlong_gnd         = lake%avg_rlong_gnd         + dtim * dlakedt%avg_rlong_gnd
      ...
      lake%upwp                  = lake%upwp                  + dtim * dlakedt%upwp
      lake%tpwp                  = lake%tpwp                  + dtim * dlakedt%tpwp
      lake%qpwp                  = lake%qpwp                  + dtim * dlakedt%qpwp
      lake%cpwp                  = lake%cpwp                  + dtim * dlakedt%cpwp
      lake%wpwp                  = lake%wpwp                  + dtim * dlakedt%wpwp
      ...
      lake%co2budget_storage     = lake%co2budget_storage     + dtim *                     &
                                   dlakedt%co2budget_storage
      lake%co2budget_loss2atm    = lake%co2budget_loss2atm    + dtim *                     &
                                   dlakedt%co2budget_loss2atm
      lake%ebudget_storage       = lake%ebudget_storage       + dtim *                     &
                                   dlakedt%ebudget_storage
      lake%ebudget_loss2atm      = lake%ebudget_loss2atm      + dtim *                     &
                                   dlakedt%ebudget_loss2atm
      lake%wbudget_storage       = lake%wbudget_storage       + dtim *                     &
                                   dlakedt%wbudget_storage
      lake%wbudget_loss2atm      = lake%wbudget_loss2atm      + dtim *                     &
                                   dlakedt%wbudget_loss2atm
      !------------------------------------------------------------------------------------!
   ...
   !   lake%upwp                = lake%upwp            * dttoti
   !   lake%tpwp                = lake%tpwp            * dttoti
   !   lake%qpwp                = lake%qpwp            * dttoti
   !   lake%cpwp                = lake%cpwp            * dttoti
   !   lake%wpwp                = lake%wpwp            * dttoti
