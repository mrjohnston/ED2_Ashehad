...
module phenology_coms
   ...
   !                                                                                       !
   !  1: prescribed phenology (one growth cycle per year, Medvigy et al.)                  !
   !                                                                                       !
   ...
   !     hardwoods - cold-deciduous;                                                       !
   !                                                                                       !
   !  4: prescribed phenology (at most two growth cycles per year, new equations)          !
   !                                                                                       !
   ...
   ! PHENFORMAT -- Data format of the prescribed phenology data:                           !
   !               0 - single text file per site; 1 - gridded HDF5 data.                   !
   !                                                                                       !
   ...
   type prescribed_phen
      ...
      !----- Parameters of the logistic function describing leaf flush. -------------------!
      real, dimension(:), pointer :: flush_a
      real, dimension(:), pointer :: flush_b
      real, dimension(:), pointer :: flush_a2
      real, dimension(:), pointer :: flush_b2

      !----- Parameters of the logistic function describing leaf color. -------------------!
      real, dimension(:), pointer :: color_a
      real, dimension(:), pointer :: color_b
      real, dimension(:), pointer :: color_a2
      real, dimension(:), pointer :: color_b2
