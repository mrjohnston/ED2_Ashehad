...
subroutine init_nbg_cohorts(csite,lsl,ipa_a,ipa_z)
   ...
   patchloop: do ipa=ipa_a,ipa_z
      ...
      pftloop: do ipft = 1,n_pft
         ...
         cpatch%bstorage(ico)         = 2.0   * ( cpatch%bleaf(ico)                        & !0.5*
                                              + cpatch%broot(ico)                          &
...
!==========================================================================================!
!==========================================================================================!
!      This subroutine initializes a lake site.                                            !
!------------------------------------------------------------------------------------------!
subroutine init_ed_lakesite(cpoly,csite,isi)
   ...
   !----- Every lake site should have only one patch. -------------------------------------!
   csite%npatches = 1
   call allocate_sitetype(csite,1)
   csite%dist_type          (1) = 3
   csite%age                (1) = 0.0
   ...
   !---------------------------------------------------------------------------------------!
   !      There is carbon and nitrogen model for lake site right now.                      !
   !---------------------------------------------------------------------------------------!
   ...
   !-----  We now set zero cohort (no plant so far) for each patch of the lake site. ------!
   patchloop: do ipa=1,csite%npatches
      cpatch => csite%patch(ipa)
   ...
   return
end subroutine init_ed_lakesite
!==========================================================================================!
!==========================================================================================!
