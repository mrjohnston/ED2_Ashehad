...
subroutine load_ed_ecosystem_params()
   ...
   !----- Expanding derived parameter list, and moving this call to after the XML read     !
   !      None of these derived parameters are used as dependants in the rest of the
   !      ed parameter scripts - RGK 03-2012
!   !----- Miscellaneous parameters that depend on the previous ones. ----------------------!
!   call init_derived_params()
!   !---------------------------------------------------------------------------------------!
...
!   MOVING THIS TO AFTER XML READS
...
subroutine init_met_params()
   ...
   atm_tmp_max = 331.     ! Highest temperature ever measured, in El Azizia, Libya
                          ! RGK 03-2013: ED may estimate the highest temperature that
                          ! ever existed, which is greater than or equal to the 
                          ! highest temperature ever recorded (adding 5 degree fudgie)
   ...
   atm_shv_max = 6.0e-2   !3.2e-2   ! That corresponds to a dew point of 32°C at 1000hPa.
   ...
   prss_max = 115000. ! It may crash if you run a simulation under water.
...
subroutine init_can_rad_params()
   ...
   leaf_emis(18)    = 9.50d-1
   leaf_emis(19:20) = 9.70d-1
   leaf_emis(21:22) = 9.60d-1
   !----- Branches. -----------------------------------------------------------------------!
   wood_emis(1)     = 9.60d-1
   ...
   wood_emis(17:20) = 9.00d-1
   wood_emis(21:22) = 9.60d-1
   !---------------------------------------------------------------------------------------!
   ...
   wood_reflect_vis(17:20) = 1.10d-1  ! 1.60d-1
   wood_reflect_vis(21:22) = 1.60d-1  ! 3.60d-1
   !----- Near infrared. ------------------------------------------------------------------!
   ...
   wood_reflect_nir(17:20) = 2.50d-1  ! 3.90d-1
   wood_reflect_nir(21:22) = 2.50d-1  ! 5.80d-1
   !---------------------------------------------------------------------------------------!
   ...
   ! MOVING THE DERIVED PARAMETER BLOCKS TO AFTER THE XML IS CALLED  RGK 03-2013
...
subroutine init_can_air_params()
   ...
   ! MOVED TO ALLOW XML UPDATES RGK 03-2013
!!!   !---------------------------------------------------------------------------------------!
...
!!!   !  MOVING TO ACCOMODATE XML INPUT
...
subroutine init_pft_photo_params()
   ...
   !--------------------------------------------------------------------------------------!
   !        Rate of diffusion for water vapor (D0), from stoma to boundary layer.         !
   !--------------------------------------------------------------------------------------!
   ...
   D0(6:8)                   = d0_tree
   D0(9:11)                  = d0_tree
   D0(12:13)                 = d0_tree  ! THESE ARE GRASSES!!!
   D0(14:15)                 = d0_tree  ! THESE ARE QUASI GRASSES!!!
   D0(16)                    = d0_grass
   D0(17:20)                 = d0_tree
   D0(21:22)                 = d0_grass
   ...
   Vm_low_temp(21)           =  4.7137          ! Dryland c4 grass
   ...
   ! ------- Factor multiplying the default Vm0 for C3 plants (1.0 = default). ------------!
   vmfact_c3  = 2.0 !1.00

   ! ------- Factor multiplying the default Vm0 for C4 plants (1.0 = default). ------------!
   vmfact_c4  = 1.5 !1.00
   ...
   Vm0(21)                   = 12.500000 * ssfact * vmfact_c4
   ...
   gamma_c3  =  0.015     ! for C3s
   gamma_c4  =  0.036 !0.040     ! for C4s
   ...
   dark_respiration_factor(21)    = gamma_c4
   dark_respiration_factor(22)    = gamma_c3
   !---------------------------------------------------------------------------------------!



   ! THE FOLLOWING BLOCK MAY CHANGE WITH THE USE OF XML PARAMETER OVERWRITES
   ! MOVING THIS TO A SUBROUTINE AFTER THE XML IS CALLED  RGK 03-2013
   ! THIS COMMENT CAN EXPIRE WHEN IT GETS OLD
...
!!!   !---------------------------------------------------------------------------------------!
   ...
   mphoto_trc3 = 9.0     ! Slopes for tropical C3s
   mphoto_tec3 = 7.19 !7.2     ! Slopes for conifers and termperate C3s
   mphoto_c4   = 5.0  !5.2     ! Slopes for C4s
   ...
   stomatal_slope(21)        = mphoto_c4
   stomatal_slope(22)        = mphoto_trc3
 
   !---------------------------------------------------------------------------------------!
   !      Define the cuticular conductances (aka the b term, given in umol/m2/s).          !
   !---------------------------------------------------------------------------------------!

   bphoto_blc3  = 10000.0   ! for broadleaf C3s
   bphoto_nlc3  = 1000.0    ! for needleleaf C3s 
   bphoto_c4    = 10000.0   ! for C4s
   ...
   quantum_efficiency(21)    = alpha_c4
   ...
   !  m²/s/kg_C_root.                                                                      !
   !                                                                                       !
   ! Water conductance for grass, in m^2/kgC_root.  This is used only when H2O_PLANT_LIM   !
   ! is not 0.                                                                             !
   !                                                                                       !
   !  Water conductance for trees, in m2/yr/kgC_root.  This is used only                   !
   !                  when H2O_PLANT_LIM is not 0.                                         !
   !---------------------------------------------------------------------------------------!

   kw_grass      = 1500.0 !900.0
   kw_tree       = 300.0  !600.0
   ...
   water_conductance(21:22)  = kw_grass / yr_sec
   !---------------------------------------------------------------------------------------!
...
subroutine init_pft_resp_params()
   ...
   growthresp   =  0.333 ! This is the default growth respiration factor
   ...
   growth_resp_factor(6)          = 0.4503
   growth_resp_factor(7)          = 0.4503
   growth_resp_factor(8)          = 0.4503
   growth_resp_factor(9)          = 0.1 !0.0
   growth_resp_factor(10)         = 0.1 !0.0
   growth_resp_factor(11)         = 0.1 !0.0
   ...
   growth_resp_factor(21)         = growthresp
   ...
   root_turnover_rate(6)          = 3.927    !3.927218 ! 0.333
   root_turnover_rate(7)          = 4.117847 ! 0.333
   root_turnover_rate(8)          = 3.927    !3.800132 ! 0.333
   root_turnover_rate(9)          = 5.0837   !5.772506
   root_turnover_rate(10)         = 5.0837
   root_turnover_rate(11)         = 5.0837   !5.070992
   ...
   root_turnover_rate(21)         = leaf_turnover_rate(21)
   ...
   ! MOVED - THESE PARAMETERS DEPEND ON vm_low_temp AND SIMILAR, 
   !         WHICH MAY CHANGE IN THE XML - RGK 03-2013
!!!   !---------------------------------------------------------------------------------------!
...
subroutine init_pft_mort_params()
   ...
   frost_mort(2:4)   = 3.0
   frost_mort(5)     = 3.0
   frost_mort(6:11)  = 0.0!3.0
   frost_mort(12:13) = 3.0
   frost_mort(14:15) = 3.0
   frost_mort(16:18) = 3.0
   frost_mort(19:20) = 0.0!3.0
   frost_mort(21)    = 0.0
   frost_mort(22)    = 3.0
   ...
   !---------------------------------------------------------------------------------------!
   ! Note: Users who change treefall_disturbance rate in the xml, are now forced to        !
   ! set mort3 as well.  Setting rho in the xml sends the user a message and halts the run !
   !---------------------------------------------------------------------------------------!
   ...
   ! THE FOLLOWING PARAMETERS MAY DEPEND ON XML CHANGES:
...
!!!   !---------------------------------------------------------------------------------------!
   ...
   b1Bl(17)    = 0.0
   b1Bl(18)    = 0.087
   b1Bl(19)    = 0.0458 ! Ter-Mikaelian and Korzukhin 1997
   b1Bl(20)    = 0.1272 ! Ter-Mikaelian and Korzukhin 1997
   b1Bl(21)    = 0.1577
   b1Bl(22)    = 0.08
   ...
   b2Bl(17)    = 0.0
   b2Bl(18)    = 1.455
   b2Bl(19)    = 1.8215 ! Ter-Mikaelian and Korzukhin 1997
   b2Bl(20)    = 1.5489 ! Ter-Mikaelian and Korzukhin 1997
   b2Bl(21)    = 0.9749
   b2Bl(22)    = 1.0
   !---------------------------------------------------------------------------------------!
   ...
   if (ibigleaf == 1 .and. (iallom == 0 .or. iallom == 1)) then
      ...
      b1Bl      (   17)  = 0.07322115
      b1Bl      (18:20)  = 0.04538826
      b1Bl      (21:22)  = 0.04538826
...
! MOVED TO AFTER XML READS FOR VM0 AND SLA DEPENDANCE
...
subroutine init_pft_leaf_params()
   ...
   use pft_coms       , only : phenology            & ! intent(out)
                             ...
                             , delta_c              & ! intent(out)
                             , flushing_temp_min    & ! intent(out)
                             , flushing_temp_max    & ! intent(out)
                             , dl_min               & ! intent(out)
                             , dl_max               & ! intent(out)
                             , dry_period           ! ! intent(out)
   ...
   c_ngrn_biom_dry(1:22)     = 1256.0    ! Forest Products Laboratory 
   wat_dry_ratio_grn(1:22)   = 2.5       ! 
   !wat_dry_ratio_grn(1:22)   = 1.5       ! Ceccato et al. 2001
   wat_dry_ratio_ngrn(1:22)  = 0.7       ! Forest Products Laboratory
   !---------------------------------------------------------------------------------------!
   ...
   ! assumption.                                                                           !
   !---------------------------------------------------------------------------------------!
   delta_c(1:22) = 100. * wat_dry_ratio_ngrn(1:22)                                         &
                 * (-0.06191 + 2.36e-4 * t3ple - 1.33e-2 * wat_dry_ratio_ngrn(1:22))
   ...
   !---------------------------------------------------------------------------------------!
   !     Parameters to determine the min temperature at which leaf can flush and the min   !
   ! temperature at which leaf can fully unfold when phenology is set to 5.                !
   !---------------------------------------------------------------------------------------!
   flushing_temp_min(1:20)=278.15 !5
   flushing_temp_min(21)=283.15   !10
   flushing_temp_min(22)=283.15   !10
   
   flushing_temp_max(1:20)=293.15 !20
   flushing_temp_max(21)=293.15   !20
   flushing_temp_max(22)=293.15   !20
   
   !---------------------------------------------------------------------------------------!
   !      Leaf photoperiod parameters from Jolly et al. 2005, Global Change Biology        !
   !---------------------------------------------------------------------------------------!
   dl_min(1:22) = 600
   dl_max(1:22) = 660

   !---------------------------------------------------------------------------------------!
   !      Leaf soil water potential parameter at which leaf starts to drop or flush.       !
   !---------------------------------------------------------------------------------------!
   dry_period(1:22) = 10.0
   return
...
!------------------------------------------------------------------------------------------!
subroutine init_derived_params()
   ...
   use physiology_coms      , only: iphysiol,klowco2,klowco28
   
   use soil_coms      , only : sldrain               & ! intent(out)
                             , sldrain8              & ! intent(out)
                             , sin_sldrain           & ! intent(out)
                             , sin_sldrain8          ! ! intent(out)

   use pft_coms       , only : D0 &
        , Vm_low_temp             &
        , Vm_high_temp            &
        , Vm_decay_e              &
        , Vm_decay_a              &
   ...
   use phenology_coms       , only : radto_min            & ! intent(out)
  ...
  use canopy_air_coms, only : veg_height_min &
                              ,chim          &
                              ,chih          &
                              ,chim8         &
                              ,chih8         &
  ...
  use rk4_coms, only : rk4min_veg_lwater     &
                       ,rk4leaf_drywhc       &
                       ,rk4leaf_maxwhc
  ...
  !---------------------------------------------------------------------------------------!
  !                     PFT dependant respiration parameters                              !
  !---------------------------------------------------------------------------------------!
  ...
  !---------------------------------------------------------------------------------------! 
   ...
   ! Set a double precision variable
   ...
   ! Print out the pft variables and other stuff
!   write(*,"(a,22f8.4,1x)")'Vm0',(Vm0(ipft),ipft=1,n_pft)
!   write(*,"(a,22f8.4,1x)")'stomatal_slope',(stomatal_slope(ipft),ipft=1,n_pft)
!   write(*,"(a,22f9.2,1x)")'cuticular_cond',(cuticular_cond(ipft),ipft=1,n_pft)
!   write(*,"(a,22f10.7,1x)")'water_conductance',(water_conductance(ipft),ipft=1,n_pft)
!   write(*,"(a,22f8.4,1x)")'dark_respiration',(dark_respiration_factor(ipft),ipft=1,n_pft)
!   write(*,"(a,22f8.4,1x)")'D0',(D0(ipft),ipft=1,n_pft)
!   write(*,"(a,22f8.4,1x)")'quantum_efficiency',(quantum_efficiency(ipft),ipft=1,n_pft)
!   write(*,"(a,f12.4,1x)")'klowco2',(klowco2)
!   write(*,"(a,22f8.4,1x)")'root_respiration',(root_respiration_factor(ipft),ipft=1,n_pft)
!   write(*,"(a,22f8.4,1x)")'growth_resp_factor',(growth_resp_factor(ipft),ipft=1,n_pft)
!   write(*,"(a,22f8.4,1x)")'leaf_width',(leaf_width(ipft),ipft=1,n_pft)
!   write(*,"(a,22f8.4,1x)")'vm_q10',(vm_q10(ipft),ipft=1,n_pft)
!   write(*,"(a,22f10.7,1x)")'leaf_reflect_vis',(leaf_reflect_vis(ipft),ipft=1,n_pft)
!   write(*,"(a,22f10.7,1x)")'leaf_reflect_nir',(leaf_reflect_nir(ipft),ipft=1,n_pft)
!   write(*,"(a,22f10.7,1x)")'wood_reflect_vis',(wood_reflect_vis(ipft),ipft=1,n_pft)
!   write(*,"(a,22f10.7,1x)")'wood_reflect_nir',(wood_reflect_nir(ipft),ipft=1,n_pft)
!   write(*,"(a,22f10.7,1x)")'leaf_trans_vis',(leaf_trans_vis(ipft),ipft=1,n_pft)
!   write(*,"(a,22f10.7,1x)")'leaf_trans_nir',(leaf_trans_nir(ipft),ipft=1,n_pft)
!   write(*,"(a,22f10.7,1x)")'wood_trans_vis',(wood_trans_vis(ipft),ipft=1,n_pft)
!   write(*,"(a,22f10.7,1x)")'wood_trans_nir',(wood_trans_nir(ipft),ipft=1,n_pft)
!   write(*,"(a,22f10.7,1x)")'leaf_scatter_vis',(leaf_scatter_vis(ipft),ipft=1,n_pft)
!   write(*,"(a,22f10.7,1x)")'wood_scatter_vis',(wood_scatter_vis(ipft),ipft=1,n_pft)
!   write(*,"(a,22f10.7,1x)")'leaf_scatter_nir',(leaf_scatter_nir(ipft),ipft=1,n_pft)
!   write(*,"(a,22f10.7,1x)")'wood_scatter_nir',(wood_scatter_nir(ipft),ipft=1,n_pft)
!   write(*,"(a,22f10.7,1x)")'leaf_backscatter_vis',(leaf_backscatter_vis(ipft),ipft=1,n_pft)
!   write(*,"(a,22f10.7,1x)")'wood_backscatter_vis',(wood_backscatter_vis(ipft),ipft=1,n_pft)
!   write(*,"(a,22f10.7,1x)")'leaf_backscatter_vis',(leaf_backscatter_nir(ipft),ipft=1,n_pft)
!   write(*,"(a,22f10.7,1x)")'wood_backscatter_nir',(wood_backscatter_nir(ipft),ipft=1,n_pft)
!   write(*,"(a,22f10.7,1x)")'orient_factor',(orient_factor(ipft),ipft=1,n_pft)
!   write(*,"(a,22f10.7,1x)")'clumping_factor',(clumping_factor(ipft),ipft=1,n_pft)
!   stop

   return
end subroutine init_derived_params
!==========================================================================================!
!==========================================================================================!
...
subroutine init_ff_coms
   ...
   light_toler_min    = 0.50!0.20
   light_toler_max    = 0.80!twothirds
