...
subroutine init_ed_patch_vars(csite,ip1,ip2,lsl)
   ...
   csite%avg_monthly_temp    (ip1:ip2) = 0.0
   csite%avg_monthly_gndwater(ip1:ip2) = 0.0
   csite%avg_monthly_waterdef(ip1:ip2) = 0.0
   csite%avg_monthly_topwaterdiff(ip1:ip2) = 0.0
...
subroutine init_ed_poly_vars(cgrid)
   ...
   do ipy = 1,cgrid%npolygons
      ...
      cgrid%min_soil_temp(ipy) = 500.0  ! 500K? Yeah probably warm enough
      cgrid%max_soil_temp(ipy) = 0.0    ! Absolute zero, probably cold enough
