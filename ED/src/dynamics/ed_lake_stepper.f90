...
module ed_lake_stepper
   ...
   ! differently.                                                                             !
   !------------------------------------------------------------------------------------------!
   subroutine integrate_lake(dtfull,htryio,nsteps,csite)
      ...
      timesteploop: do i=1,maxstp
         ...
         call lake_derivs(lake_buff%y,lake_buff%dydx,csite)
         ...
         hstep:   do
            ...
            case (1)
               call lake_rk4(lake_buff%y,lake_buff%dydx,lake_buff%ytemp,lake_buff%yerr        &
                            ...
                            ,lake_buff%ak6,lake_buff%ak7,x,h,reject_step,reject_result,csite)

            case (2)
               call lake_heun(lake_buff%y,lake_buff%dydx,lake_buff%ytemp,lake_buff%yerr       &
                             ,lake_buff%ak2,lake_buff%ak3,x,h,reject_step,reject_result,csite)
   ...
   !                                                                                          !
   !------------------------------------------------------------------------------------------!
   subroutine lake_heun(y,dydx,ytemp,yerr,ak2,ak3,x,h,reject_step,reject_result,csite)
      ...
      ! predicted state.                                                                      !
      !---------------------------------------------------------------------------------------!
      call lake_derivs(ak3,ak2,csite)
      !---------------------------------------------------------------------------------------!
   ...
   !------------------------------------------------------------------------------------------!
   subroutine lake_rk4(y,dydx,yout,yerr,ak2,ak3,ak4,ak5,ak6,ak7,x,h,reject_step,reject_result,csite)
      ...
      call lake_derivs(ak7, ak2, csite)
      !---------------------------------------------------------------------------------------!
      ...
      !------ Get the new derivative evaluation. ---------------------------------------------!
      call lake_derivs(ak7, ak3, csite)
      !---------------------------------------------------------------------------------------!
      ...
      !------ Get the new derivative evaluation. ---------------------------------------------!
      call lake_derivs(ak7, ak4, csite)
      !---------------------------------------------------------------------------------------!
      ...
      !------ Get the new derivative evaluation. ---------------------------------------------!
      call lake_derivs(ak7, ak5, csite)
      !---------------------------------------------------------------------------------------!
      ...
      !------ Get the new derivative evaluation. ---------------------------------------------!
      call lake_derivs(ak7, ak6, csite)
      !---------------------------------------------------------------------------------------!
