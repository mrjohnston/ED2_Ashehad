   ...
   case (0)
      ...
      polyloop: do ipy = 1,cgrid%npolygons
         ...
         siteloop: do isi = 1,cpoly%nsites
            ...
            !------------------------------------------------------------------------------!
            !    No recruitment for a lake site unless hydrophytes are added in the future.!
            !------------------------------------------------------------------------------!
            ...
            patchloop: do ipa = 1,csite%npatches
               ...
               !----- Normalise the monthly mean top soil water. --------------------------!
               ...
               pftloop: do ipft = 1, n_pft
                  ...
                  if( include_pft(ipft)                                         .and.      &
                      ...
                      repro_scheme /= 0 .and. csite%avg_monthly_topwaterdiff(ipa) >0 ) then
               ...
               !----- Reset the topwaterdiff for next month. ------------------------------!
               csite%avg_monthly_topwaterdiff(ipa) = 0.
               !---------------------------------------------------------------------------!
            end do patchloop
   ...
   case (1)
      ...
      polyloop_big: do ipy = 1,cgrid%npolygons
         ...
         siteloop_big: do isi = 1,cpoly%nsites
            ...
            !--No recruitment for a lake site unless hydrophytes are added in the future.--!
            if ( cpoly%islakesite(isi) ==1 ) cycle siteloop_big
...
subroutine seed_dispersal(cpoly,late_spring)
   ...
   case (4)
      !------------------------------------------------------------------------------------!
      !     Seeds stay in the same patches.                                                !
      !------------------------------------------------------------------------------------!
      siteloop3: do isi = 1,cpoly%nsites
         ...
         !      Loop over the donor cohorts.                                               !
         !---------------------------------------------------------------------------------!
         donpaloop3: do donpa = 1,csite%npatches
            donpatch => csite%patch(donpa)

            doncoloop3: do donco = 1, donpatch%ncohorts
               ...
               !   Spread the seedlings across all patches in this site.                   !
               !---------------------------------------------------------------------------!
               recpaloop3: do recpa = 1,csite%npatches
