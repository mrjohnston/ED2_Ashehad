...
subroutine ed_masterput_nl(par_run)
   ...
   use soil_coms            , only : isoilflg                  & ! intent(in)
                                   ...
                                   , soilwater_db              & ! intent(in)
                                   , n_soilwater_points        & ! intent(in)
                                   , soilwater_years           & ! intent(in)
                                   , soilwater_months          & ! intent(in)
                                   , soilwater_dates           & ! intent(in)
   ...
   call MPI_Bcast(soilwater_db    ,str_len,MPI_CHARACTER,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(ed_met_driver_db,str_len,MPI_CHARACTER,mainnum,MPI_COMM_WORLD,ierr)

   call MPI_Bcast(n_soilwater_points ,1,MPI_INTEGER,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(soilwater_years,60,MPI_INTEGER,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(soilwater_months,60,MPI_INTEGER,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(soilwater_dates,60,MPI_INTEGER,mainnum,MPI_COMM_WORLD,ierr) 
   ...
   call MPI_Bcast(phenformat,1,MPI_INTEGER,mainnum,MPI_COMM_WORLD,ierr)
...
#if defined(COUPLED)
#else
   call MPI_Bcast(include_lakesite,1,MPI_INTEGER,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(waterfrac,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr)
#endif
...
subroutine ed_nodeget_nl
   ...
   use soil_coms            , only : isoilflg                  & ! intent(out)
                                   ...
                                   , soilwater_db              & ! intent(out)
                                   , n_soilwater_points        & ! intent(out)
                                   , soilwater_years           & ! intent(out)
                                   , soilwater_months          & ! intent(out)
                                   , soilwater_dates           & ! intent(out)
...
!----- Now the namelist -------------------------------------------------------------------!
   ...
   call MPI_Bcast(soilwater_db    ,str_len,MPI_CHARACTER,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(ed_met_driver_db,str_len,MPI_CHARACTER,master_num,MPI_COMM_WORLD,ierr)

   call MPI_Bcast(n_soilwater_points,1,MPI_INTEGER,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(soilwater_years,60,MPI_INTEGER,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(soilwater_months,60,MPI_INTEGER,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(soilwater_dates,60,MPI_INTEGER,master_num,MPI_COMM_WORLD,ierr)
   ...
   call MPI_Bcast(phenformat,1,MPI_INTEGER,master_num,MPI_COMM_WORLD,ierr)
...
#if defined(COUPLED)
#else
   call MPI_Bcast(include_lakesite,1,MPI_INTEGER,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(waterfrac,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr)
#endif
