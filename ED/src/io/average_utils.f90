...
subroutine normalize_ed_daily_output_vars(cgrid)
   ...
   polyloop: do ipy=1,cgrid%npolygons
      ...
      cgrid%dmean_albedo        (ipy)  = sss_albedo         * poly_area_i
      cgrid%dmean_albedo_beam   (ipy)  = sss_albedo_beam    * poly_area_i
      cgrid%dmean_albedo_diffuse(ipy)  = sss_albedo_diffuse * poly_area_i
...
subroutine zero_ed_daily_output_vars(cgrid)
   ...
   do ipy = 1,cgrid%npolygons
      ...
      ! THESE ZEROING IS UNECESSARY
      ! BECAUSE THEY ARE NOT INTEGRATED
      ! THEY ARE DIAGNOSED DIRECTLY OFF
      ! OFF THE PATCH LEVEL VARIABLES
