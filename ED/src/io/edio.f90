      ...
      polyloop: do ipy=1,cgrid%npolygons
         ...
         siteloop: do isi=1,cpoly%nsites
            ...
            do k=cpoly%lsl(isi),nzg
               ...
               ! Note that the soil column is replaced by a water column in a lake site.   ! 
               !---------------------------------------------------------------------------!
               ...
               do ipa=1,csite%npatches
                  ...
                  if (cpoly%islakesite(isi) == 1) then
                     !---- For a lake site, dry matter mass is zero. So dry heat capacity -!
                     !---- is zero too.                                                   -!
                     site_avg_soil_hcap(k) = site_avg_soil_hcap(k) +  0.0 
                  else
